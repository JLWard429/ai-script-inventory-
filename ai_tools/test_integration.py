#!/usr/bin/env python3
"""
Integration test for the AI Orchestra system
...
def main():
    """Run integration test for AI Orchestra system"""
    print("\n" + "="*80)
    print("AI ORCHESTRA INTEGRATION TEST")
    print("="*80)
    print(f"Date/Time: 2025-08-27 18:32:24")
    ...
    investigation = InvestigationCore("integration_test", test_dir)
    ...
    with open(doc1_path, 'w') as f:
        f.write("""
Medical Report - Patient ID: 12345
Date: 2025-05-15
...
Dr. Johnson has reviewed the case and confirms these findings.
    ...
    with open(doc2_path, 'w') as f:
        f.write("""
Follow-up Report - Patient ID: 12345
Date: 2025-06-01
Hospital: Metro Medical Center
...
Next appointment scheduled for June 15th, 2025.
    ...
    with open(doc3_path, 'w') as f:
        f.write("""
Specialist Consultation - Patient ID: 12345
Date: 2025-06-05
...
Dr. Johnson
    ...
    # Add documents to investigation
